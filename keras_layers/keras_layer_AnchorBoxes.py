...
class AnchorBoxes(Layer):
    ...
    def call(self, x, mask=None):
        ...
        # below line changed per github issue
        if K.image_data_format() == 'channels_last':  # instead of 'tf'
            batch_size, feature_map_height, feature_map_width, feature_map_channels = x._keras_shape
            # below line added per github issue
            ...
            # below line added e=per github issue
